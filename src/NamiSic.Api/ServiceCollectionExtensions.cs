...
using NamiSic.Api.Auth;
using NamiSic.Api.Auth.Handlers;
using NamiSic.Api.Constants;
using NamiSic.Api.Models.DTOs.Residents;
using NamiSic.Api.Options;
...
public static class ServiceCollectionExtensions
{
    ...
    private static IServiceCollection AddAuth(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        string? isServerUrl = configuration.GetValue<string>(NamiSic.Api.Constants.ConfigurationSection.IdServerUrl);
        ...
        string? clientId = configuration.GetValue<string>(NamiSic.Api.Constants.ConfigurationSection.ClientId);
